...
def train_model(ai_filter_num, df, code, min_unit, date_start):
...
def use_model(ai_filter_num, coin_df, code, unit, date_start):
...
_loss_{ai_settings['loss']}_activation_{ai_settings['activation']}.h5"""
        ...
        # 저장된 모델이 없는 경우 학습
        filtered = train_model(ai_filter_num, coin_df, code, date_start)
